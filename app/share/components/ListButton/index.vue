<template>
  <div class="flex w-full h-min cursor-pointer gap-3 p-3.5 border border-gray-200 rounded-xl items-center">
    ...
    <div class="flex flex-1 flex-col gap-1.5">
      <p class="font-bold text-sm">Lista 56431</p>
      <span class="text-xs font-medium text-gray-600">1 categoria / 1 item</span>
    </div>
